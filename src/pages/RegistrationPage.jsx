...
import { registrationUser } from '../redux/slices/authSlice.js'
...
const RegistrationPage = () => {
    ...
    const handleRegistration = (newUser) => {
        dispatch(registrationUser(newUser))
        success()
        setTimeout(() => {
                    ...
                    <div className="form">
                        <form onSubmit={handleSubmit(handleRegistration)}>
                            <div className="mb-4 flex flex-col">
                                ...
                                <p className="max-w-[300px] text-xs text-right self-end text-red-500">
                                    ...
                                    <Controller
                                        ...
                                        rules={{
                                            ...
                                            pattern: {
                                                ...
                                                message:
                                                    'Минимум 8 символов, минимум 1 заглавная буква, 1 прописная, 1 число и 1 символ',
                                            },
                                        }}
                                        render={({ field }) => (
                                            <Input.Password
